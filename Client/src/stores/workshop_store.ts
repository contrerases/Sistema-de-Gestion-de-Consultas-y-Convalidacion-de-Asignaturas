...
import { getAllWorkshops, deleteWorkshop, insertWorkshop } from '@/services/workshop_api'

import type { WorkshopResponse, WorkshopBase, WorkshopPost } from '@/interfaces/workshop_model'
