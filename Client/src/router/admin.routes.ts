...
export const adminRoutes = [
  {
    ...
    children: [
      ...
      { path: 'history', name: 'admin.history', component: HistoryModule },
      {
        ...
        children: [
          { path: 'current', name: 'admin.workshops.current', component: WorkshopsCurrentList },
          { path: 'past', name: 'admin.workshops.past', component: WorkshopsPastList },
        ],
      },
      { path: 'courses', name: 'admin.courses', component: CurriculumCoursesModule },
      { path: 'subjects', name: 'admin.subjects', component: SubjectsModule },
      { path: 'departments', name: 'admin.departments', component: DepartmentModule },
