...
export default [
  {
    ...
    rules: {
      ...
      'vue/no-unused-properties': ['error', { 'groups': ['props', 'data', 'computed', 'methods'] }], // Marca propiedades no usadas
      ...
      'vue/define-macros-order': ['error', { // Define el orden de los macros de Vue
