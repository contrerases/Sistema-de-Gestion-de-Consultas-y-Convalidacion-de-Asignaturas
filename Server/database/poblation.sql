...
VALUES ('LIBRE 1', 1),
    ...
    ('LIBRE 7', 1),
    (
        'ELECTIVO DE INFORMATICA 1',
        2
    ),
    (
        'ELECTIVO DE INFORMATICA 2',
        2
    ),
    (
        'ELECTIVO DE INFORMATICA 3',
        2
    ),
    (
        'ELECTIVO DE INFORMATICA 4',
        2
    ),
    ('ELECTIVO 1', 3),
    ('ELECTIVO 2', 3),
...
VALUES (
    ...
    (
        'HRW131',
        'FORMAC.Y LIDERAZGO EMPRESARIAL',
        5,
        2
    ),
    (
    ...
    (
        'HRW153',
        'PRACTICA EN ACCION COMUNITARIA',
        5,
        2
    ),
    (
