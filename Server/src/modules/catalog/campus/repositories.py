...
from src.modules.catalog.campus.models import Campus
...
class CampusRepository:
    ...
    def update(self, campus_id: int, acronym: str, name: str, location: str) -> Optional[Campus]:
        """Actualiza un campus"""
        campus = self.get_by_id(campus_id)
        if campus:
            campus.acronym = acronym
            campus.name = name
