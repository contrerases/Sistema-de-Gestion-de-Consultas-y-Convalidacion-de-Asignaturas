...
class AdministratorRepository:
    ...
    def get_all(
        ...
        query = (
            ...
            .filter(User.user_type.has(name="ADMINISTRATOR"))
        )
    ...
    def get_by_id(self, admin_id: int) -> Optional[User]:
        ...
        return (
            ...
            .filter(User.id == admin_id, User.user_type.has(name="ADMINISTRATOR"))
            .first()
        )

    def count(self, campus_id: Optional[int] = None) -> int:
        """Cuenta el total de administradores"""
        query = self.db.query(User).filter(User.user_type.has(name="ADMINISTRATOR"))
