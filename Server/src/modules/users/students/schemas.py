...
class StudentBase(BaseModel):
    ...
    email: str = Field(..., max_length=255, description="Email institucional del estudiante")
    full_name: str = Field(..., min_length=2, max_length=255, description="Nombre completo")
    id_campus: int = Field(..., description="ID del campus")
    rol_student: str = Field(..., min_length=9, max_length=11, description="ROL del estudiante")
    rut_student: str = Field(..., min_length=7, max_length=9, description="RUT del estudiante")
