...
MSG_INVALID_EMAIL_DOMAIN = (
    "El email debe pertenecer al dominio usm.cl, estudiante.usm.cl, sansano.usm.cl"
)
...
MSG_STUDENT_DATA_REQUIRED = (
    "Los datos de estudiante (ROL y RUT) son obligatorios para usuarios tipo STUDENT"
)
MSG_STUDENT_DATA_FORBIDDEN = (
    "Los datos de estudiante (ROL y RUT) no deben proporcionarse para administradores"
)
