...
class SubjectRepository:
    ...
    def get_by_department(self, department_id: int, skip: int = 0, limit: int = 100) -> List[Subject]:
    ...
    def create(self, acronym: str, name: str, id_department: int, credits: int) -> Subject:
    ...
    def update(
        ...
        if subject:
            ...
            subject.name = name
            subject.id_department = id_department
